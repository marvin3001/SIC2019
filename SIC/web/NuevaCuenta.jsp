                                    ...
                                    <div class="panel-body">
                                        <div id="morris-line-chart">
                                            ...
                                            <form id="formulario" action="AgregarCuentas.do"  method="get" role="form"  >
                                                ...
                                                <button  type="submit" onclick="test(this.form);" class="btn btn-primary">
                                                    Registrar
                                                </button>
                                            ...
                                            <form method="get" 
                                                ...
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        id = request.getParameter("cuentas");
                                                    } catch (Exception e) {
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                    ...
                                                    <tbody>
                                                        <%  if (cuenta.obtenerlistaCuenta(id).size() > 0) {

                                                                for (Cuentas cl : cuenta.obtenerlistaCuenta(id)) {
                                                        %>
                                                        <tr class="gradeU">
                                                            <td><%=cl.getCuenta()%></td>
                                                            <td><%=cl.getNombre()%></td>
